...
const CartWidget = () => {
    ...
    return (
        <Link to="/cart" className="cartQuantity">
        {amountOfItemsInCart >  0 && (
            <span className="itemsQuantity">{amountOfItemsInCart}</span>
        )}
        <button className='cartwidget'>
            <svg xmlns="http://www.w3.org/2000/svg"  className=" icon_cart icon icon-tabler icon-tabler-shopping-cart-filled" width="30" height="44" viewBox="0 0 24 24" strokeWidth="2" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
