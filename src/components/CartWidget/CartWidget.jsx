...
const CartWidget = () => {
    return (
        <button className='cartwidget'>
            <svg xmlns="http://www.w3.org/2000/svg" className="icon"  class="icon icon-tabler icon-tabler-shopping-cart-filled" width="30" height="44" viewBox="0 0 24 24" stroke-width="2" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
