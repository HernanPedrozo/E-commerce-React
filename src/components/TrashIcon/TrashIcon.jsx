...
export default function () {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="trash" width="30" height="40" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#000000" fill="none" strokeLinecap="round" strokeLinejoin="round">
