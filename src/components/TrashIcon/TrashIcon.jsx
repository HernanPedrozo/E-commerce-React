...
export default function () {
    ...
    <button className='Trash'>
        <svg xmlns="http://www.w3.org/2000/svg" className=" icon_color icon icon-tabler icon-tabler-trash-filled" width="30" height="40" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#000000" fill="none" strokelinecap="round" strokelinejoin="round">
