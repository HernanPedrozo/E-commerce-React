...
<svg xmlns="http://www.w3.org/2000/svg" className="icon_color icon-tabler icon-tabler-backspace-filled" width="35" height="40" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ff4500" fill="none" strokeLinecap="round" strokeLinejoin="round">
